<?php
$_['heading_title'] = 'Tarlan Payments';
...
$_['callback_uri_help'] = 'Provide this link into the Tarlan Payments support team.';
$_['redirect_uri_label'] = 'Redirect URL';
$_['redirect_uri_help'] = 'Provide this link into the Tarlan Payments support team.';
$_['gw_uri_label'] = 'Gateway URL';
$_['gw_uri_entry'] = 'https://api.sandbox.tarlanpayments.kz/v3.0';
$_['gw_uri_help'] = 'The url of Tarlan Payments payment gateway. Leave blank to use default value.';
$_['account_id_label'] = 'Account ID';
$_['account_id_entry'] = 'Account ID';
$_['account_id_help'] = 'Get this from the Information/Accounts section on Tarlan Payments dashboard page.';
$_['account_id_error'] = 'The Account ID is a required field.';
$_['secret_key_label'] = 'Secret Key';
$_['secret_key_entry'] = 'Secret Key';
$_['secret_key_help'] = 'Get this from the Information/Accounts section on Tarlan Payments dashboard page.';
...
$_['error_permission'] = '<strong>Warning:</strong> You do not have permission to modify payment Tarlan Payments!';
...
$_['text_tarlanpayments'] = '<a target="_BLANK" href="https://tarlanpayments.kz"><img src="view/image/payment/tarlanpayments.png" alt="Tarlan Payments" title="Tarlan Payments" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_success'] = 'Success: You have modified Tarlan Payments payment module!';
